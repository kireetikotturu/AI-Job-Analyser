...
import { Mail, Lock, User, UserPlus, Loader2, XCircle, Sparkles } from "lucide-react";
    ...
    <div className="min-h-[calc(100vh-73px)] bg-hero-gradient flex items-center justify-center px-6 py-16">
      ...
      >
        <div className="flex flex-col items-center text-center mb-6">
          ...
          <p className="text-sm text-ink/55 mt-1">Save resume history and unlock unlimited analyses with Pro.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-xs font-semibold text-ink/60 mb-1.5 block">Name</label>
